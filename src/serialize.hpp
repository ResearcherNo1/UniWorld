...
inline std::string *operator""_R(char const *s, size_t n)
{
...
inline long double *operator""_R(long double t)
{
...
inline long long *operator""_R(unsigned long long t)
{
